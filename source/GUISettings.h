...
struct GUISettings {
	...
	TableSettings boostTableConfig{ {
		...
		{"Collected",				[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.amount_collected); }, false},
		{"Stolen",					[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.amount_stolen); }, true},
		{"Pads amount",				[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.amount_collected_small); }, false},
		{"Pills amount",			[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.amount_collected_big); }, false},
		{"Pads amount stolen  ",	[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.amount_stolen_small); }, false},
		{"Pills amount stolen",		[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.amount_stolen_big); }, false},
		{"Pads",					[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.count_collected_small); }, false},
		{"Pills",					[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.count_collected_big); }, false},
		{"Pads stolen",				[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.count_stolen_small); }, false},
		{"Pills Stolen",			[](Team::Player& p) {ImGui::Text("%i",   p.stats.boost.count_stolen_big); }, false},
	...
	TableSettings movementTableConfig{ {
		...
		{"Time Supersonic",			[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.movement.time_supersonic_speed, p.stats.movement.percent_supersonic_speed); }, true},
		{"Time boost speed",		[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.movement.time_boost_speed, p.stats.movement.percent_boost_speed); }, true},
		{"Time slow speed",			[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.movement.time_slow_speed, p.stats.movement.percent_slow_speed); }, true},
		{"Time ground",				[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.movement.time_ground, p.stats.movement.percent_ground); }, true},
		{"Time low air",			[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.movement.time_low_air, p.stats.movement.percent_low_air); }, true},
		{"Time high air",			[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.movement.time_high_air, p.stats.movement.percent_high_air); }, true},
	...
	TableSettings positioningTableConfig{ {
		...
		{"Avg ball distance w possession",		[](Team::Player& p) {ImGui::Text("%i",   p.stats.positioning.avg_distance_to_ball_possession); }, false},
		{"Avg ball distance w/o possession",	[](Team::Player& p) {ImGui::Text("%i",   p.stats.positioning.avg_distance_to_ball_no_possession); }, false},
		{"Avg distance to team",				[](Team::Player& p) {ImGui::Text("%i",   p.stats.positioning.avg_distance_to_mates); }, true},
		{"Time defensive 1/3",					[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_defensive_third, p.stats.positioning.percent_defensive_third); }, true},
		{"Time neutral 1/3",					[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_neutral_third, p.stats.positioning.percent_neutral_third); }, true},
		{"Time offensive 1/3",					[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_offensive_third, p.stats.positioning.percent_offensive_third); }, true},
		{"Time defensive 1/2",					[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_defensive_half, p.stats.positioning.percent_defensive_half); }, false},
		{"Time offensive 1/2",					[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_offensive_half, p.stats.positioning.percent_offensive_half); }, false},
		{"Time behind ball",					[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_behind_ball, p.stats.positioning.percent_behind_ball); }, false},
		{"Time infront ball",					[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_infront_ball, p.stats.positioning.percent_infront_ball); }, false},
		{"Time most back",						[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_most_back, p.stats.positioning.percent_most_back); }, false},
		{"Time most forward",					[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_most_forward, p.stats.positioning.percent_most_forward); }, false},
		{"Time closest to ball",				[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_closest_to_ball, p.stats.positioning.percent_closest_to_ball); }, false},
		{"Time farthest from ball",				[](Team::Player& p) {ImGui::Text("%.0fs (%.0f%%)", p.stats.positioning.time_farthest_from_ball, p.stats.positioning.percent_farthest_from_ball); }, false},
