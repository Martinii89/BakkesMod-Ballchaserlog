...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_OPTIONAL(CumulativePlayerStats, core, boost, movement, positioning, demo, games, wins, win_percentage, play_duration);
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_OPTIONAL(BallchasingUser, avatar, avatar_full, avatar_medium, name, profile_url, steam_id);
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_OPTIONAL(ReplayList::ReplayData::Team::Player, end_time, id, mvp, name, rank, score, start_time);
