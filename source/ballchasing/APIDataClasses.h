...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_OPTIONAL(ReplayList::ReplayData::Uploader, avatar, name, profile_url, steam_id);
...
NLOHMANN_DEFINE_TYPE_NON_INTRUSIVE_OPTIONAL(ReplayList::ReplayData::Team, goals, name);
