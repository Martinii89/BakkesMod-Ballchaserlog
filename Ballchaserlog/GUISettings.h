...
struct GUISettings {
	...
	TableSettings boostTableConfig{ {
		...
		{"Time 0",				[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.time_zero_boost); }, false},
		{"Time 0-25",				[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.time_boost_0_25); }, false},
		{"Time 25-50",			[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.time_boost_25_50); }, false},
		{"Time 50-75",			[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.time_boost_50_75); }, false},
		{"Time 75-100",			[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.time_boost_75_100); }, false},
		{"Time 100",				[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.time_full_boost); }, false},
		{"%%0",			[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.percent_zero_boost); }, true},
		{"%%0-25",			[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.percent_boost_0_25); }, true},
		{"%%25-50",			[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.percent_boost_25_50); }, true},
		{"%%50-75",			[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.percent_boost_50_75); }, true},
		{"%%75-100",		[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.percent_boost_75_100); }, true},
		{"%%Full",			[](Team::Player& p) {ImGui::Text("%.1f", p.stats.boost.percent_full_boost); }, true},
	} };
